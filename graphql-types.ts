...
export type ProfilePicQueryVariables = Exact<{ [key: string]: never; }>;


export type ProfilePicQuery = { placeholderImage?: Maybe<{ childImageSharp?: Maybe<{ fluid?: Maybe<GatsbyImageSharpFluidFragment> }> }> };
...
export type BlogDataQuery = { mdx?: Maybe<(
    Pick<Mdx, 'body' | 'excerpt'>
    & { frontmatter?: Maybe<Pick<MdxFrontmatter, 'title' | 'ogImage' | 'date' | 'description'>> }
  )> };
